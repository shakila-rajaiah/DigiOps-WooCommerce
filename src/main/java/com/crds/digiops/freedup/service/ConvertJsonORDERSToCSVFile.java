...
//    public static String readFileAsString(String json, String flag)throws Exception
//    
//    {
//    	String message = convertJSONString(json,flag) ;
...
//    }
     ...
     * @Modified 4/8/2023 - added weekly or bimonthly flag
     * @param json
     * @return
   ...
   public static String convertJSONString(String json, String flag) throws JSONException, UnknownHostException {
	      ...
	      try {
	    	  ...
	    	  System.out.println("orders all size : " + orders.size()); 
	  	      ...
	  	      // commented off briefly to create reports for the month of March.
//	    	  // choose only the current orders for this period 
	    	  for (OrderPOJO oP: orders ) {
	    		  ...
	    		  if (flag == "weekly") {
		    			if (DateFormatterUtil.isWithinDateRangeForWeek(oP)) {
		    				currOrders.add(oP);
		    			}
	    		  }
	    		  else if (flag =="bimonthly") 
	    		  {
	    			...
	    			System.out.println("********localCreateDate" + currentDate + " day : " +day);
		    		if (day <= 15)  {	
			    			if (DateFormatterUtil.isWithinDateRangeForCurrentMonthFirstHalfNew(oP)) {
			    				currOrders.add(oP);
			    			}
		    		}
		    		else if(day>=16){
			    			if (DateFormatterUtil.isWithinDateRangeForPrevMonthSecondHalfNew(oP)) {
			    				currOrders.add(oP);
			    			}
		    		  }
	    		  }
	    		  ...
	    		  {	
		    			if (DateFormatterUtil.isWithinDateRangeForPrevMonth(oP)) {
		    				currOrders.add(oP);
		    			}
	    		  }
	    	  }
...
//				  orderPOJOs.add(i, opc);
    ...
    * @called from: public static void apiGetAllOrders() throws IOException {
    */
  public static String convertJSONString(String json, String startDate, String endDate) throws JSONException, UnknownHostException {
...
//	    	  // choose only the current orders for this period 
	    	  ...
	    	  for (OrderPOJO oP: orders ) {
	    		  ...
	    		  String str =oP.getDate_created().substring(0, 10);
	    		  System.out.println ("OP Date : " + oP.getDate_created());
  	    		  //isWithinStartDateAndStopdate(OrderPOJO oP, String startDate, String endDate)
	    			if (DateFormatterUtil.isWithinStartDateAndStopdate( oP, startDate, endDate)) {
	    					currOrders.add(oP);
	    			}		    		  
	    	  }
